# Translation DL pipeline for Language Model fine-tuning

## For PrompTart-terms-translation

### Dataset
PrompTart-terms-translation dataset(generated from LLM using API)

### Quick setup

```bash
# clone project
git clone https://github.com/DimensionSTP/promptart-terms-translation.git
cd promptart-terms-translation
